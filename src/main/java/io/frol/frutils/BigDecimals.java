...
public final class BigDecimals {
    ...
    public static boolean anyNull(final BigDecimal... values) {
    ...
    public static boolean allNull(final BigDecimal... values) {
        for (final BigDecimal value : values) {
            if (notNull(value)) {
                return false;
            }
    ...
    public static boolean allNotNull(final BigDecimal... values) {
        return !anyNull(values);
    }

    public static boolean notNull(final BigDecimal value) {
        return !isNull(value);
    }
